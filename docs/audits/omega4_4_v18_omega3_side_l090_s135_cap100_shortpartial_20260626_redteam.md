...
- Model id: `omega4_4_v18_omega3_side_l090_s135_cap100_shortpartial_20260626`
- Variant: `side_l0p90_s1p35_cap1p00_shortpartial`
- Audit JSON: `tmp/causal_regen_20260516/omega4_4_v18_omega3_side_l090_s135_cap100_shortpartial_20260626/redteam_report.json`
...
| candidate_validation | 47.1569 | -13.3093 | 41 | 0.5610 | 0.8450 | 5 | 0.218611 |
| baseline_oos_readout | 43.2312 | -10.7585 | 34 | 0.6765 | 0.7931 | 0 | 0.290538 |
| candidate_oos_readout | 59.5596 | -10.2252 | 35 | 0.7143 | 0.8961 | 4 | 0.375343 |
...
- PASS `candidate_manifest_model_id`: model_id=omega4_4_v18_omega3_side_l090_s135_cap100_shortpartial_20260626
- PASS `promotion_manifest_model_id`: model_id=omega4_4_v18_omega3_side_l090_s135_cap100_shortpartial_20260626
- PASS `runtime_contract_model_id`: model_id=omega4_4_v18_omega3_side_l090_s135_cap100_shortpartial_20260626
...
- PASS `manifest_validation_pnl_matches_fine_sweep`: manifest=47.15691854350788 fine=47.15691854350788
- PASS `manifest_validation_mdd_matches_fine_sweep`: manifest=-13.309314861891874 fine=-13.309314861891874
...
- PASS `manifest_validation_avg_notional_matches_fine_sweep`: manifest=0.8449887433758866 fine=0.8449887433758866
- PASS `manifest_validation_avg_margin_fraction_matches_fine_sweep`: manifest=0.4224943716879433 fine=0.4224943716879433
...
- PASS `manifest_validation_log_risk_utility_matches_fine_sweep`: manifest=0.21861098693442607 fine=0.21861098693442607
- PASS `manifest_oos_pnl_matches_fine_sweep`: manifest=59.55957974650487 fine=59.55957974650487
- PASS `manifest_oos_mdd_matches_fine_sweep`: manifest=-10.225215707071666 fine=-10.225215707071666
...
- PASS `manifest_oos_avg_notional_matches_fine_sweep`: manifest=0.896109310986158 fine=0.896109310986158
- PASS `manifest_oos_avg_margin_fraction_matches_fine_sweep`: manifest=0.448054655493079 fine=0.448054655493079
...
- PASS `manifest_oos_log_risk_utility_matches_fine_sweep`: manifest=0.3753430913683788 fine=0.3753430913683788
- PASS `validation_pnl_improves`: candidate=47.15691854350788 baseline=35.853831530265
- PASS `oos_pnl_improves_diagnostic`: candidate=59.55957974650487 baseline=43.2312455386217
- PASS `validation_mdd_improves_for_strict_promotion`: candidate=-13.309314861891874 baseline=-14.16964911682127
- PASS `oos_mdd_improves_diagnostic`: candidate=-10.225215707071666 baseline=-10.758485734455137
