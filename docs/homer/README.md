...
- ⭐**유일한 후보는 자산 수다**: ETH+XRP+SOL 동일가중(자산당 동시 2, 자산별 실행가능 셀)이 VAL·OOS 두 창
  모두 일손익 CI > 0인 유일한 구성(샤프 3.52 / 4.18 vs ETH 단독 2.98 / 2.01). 근거가 적합이 아니라 **교차자산
  일손익 무상관(0.05~0.29)**이다. **다음 행동 = XRP·SOL 섀도우 러너 추가**(§5.19 포팅 프로토콜, A4 캡 정합 먼저).
