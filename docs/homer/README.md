...
**⇒ 화면 임계값 0.55/0.60 상향 권고, 사용자 승인 대기.** 일단 0.50으로 서빙하되 app.js
"자세히"에 "50%는 분류 기준이지 매매 가능 기준이 아니다"를 명시했다.
...
**미결**: 화면 임계값 0.50→0.55/0.60 상향 여부(위 경제성 표) — 사용자 승인 대기.
BTC는 손대지 않아 여전히 게이트 구조다. 전체 경위: `docs/homer/v_rebound_open_issues_20260901.md`
12번 항목.
