...
⭐**예산 추가매수**(청산 사다리의 거울상 — 순행으로 한도가 늘면 그만큼 추가)가 배포 팔을 **3/3 창**
이겼고 OOS 는 최악 1건도 −23.5 → −16.1 로 낫다. 시간 분할(6/6 전패)·가격 분할(비용선 0/9)이
죽은 뒤 남은 유일한 분할 축이다. **아직 배포하지 않는다** — 정확도 하나(0.60)뿐이다.
