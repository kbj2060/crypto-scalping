...
§5.22 축13에서 직접 측정 완료 — **부분 반증**: 2/8에 희미한 방향력 존재,
단 AUC 0.538~0.576으로 비용을 못 넘음).
...
#### ⭐축 13 (2026-09-05) — (b)를 직접 재니 **부분 반증**됐다
...
13개 축이 전부 닫혔다. 여기서 14번째·15번째 변형을 돌리는 건 성실함이 아니라 **이 저장소가
반복해서 문서화한 실패 양식**이다:
...
| **방향력** | **직접 측정**(축 13) | 통합 AUC 0.5142 CI[0.493,0.536] · 2종만 0.54급 |
