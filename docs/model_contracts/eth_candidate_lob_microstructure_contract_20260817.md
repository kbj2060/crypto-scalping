...
| **모델링** | 착수 전 — raw 레벨이 방금 축적을 시작했으므로 최소 축적 기간이 필요. 아래 "다음 단계" 참고. |
...
- **모델링 착수 시점**: raw 레벨이 2026-08-17부터 막 축적을 시작했다. 최소 며칠~수주 분량이
  쌓인 뒤 스모크 실험(파이프라인 검증)부터 시작하고, 방향성 결론을 낼 만한 표본은 그보다 훨씬
  나중이다 — 정확한 최소 기간 기준은 다음 세션에서 정한다.
...
- WS-E 격리 파일럿의 72h 소크가 왜 53.08h에서 멈췄는지(의도적 중단 vs 세션 종료) 미확인 —
  낮은 우선순위.
- raw 레벨 모델링 착수를 위한 최소 축적 기간 기준 미정.
