...
| **레짐 사이드카 (최종 채택)** | `data/ensemble/supervised/omega461_balnobb_cut2509_20260909/training_features_{2024,2025,2026_rebuilt}_regime3_balnobb_cut2509_sidecar.csv` | 2024~2026-08 | **이 라인의 레짐 6컬럼, K=0** | **active(채택)** | balancedish − BB덮어쓰기 + HGB. 컷오프 ≤2025-09-30, purged 5-fold OOF. 모델 `regime_balnobb_cut2509_model.joblib`. ⚠️전환 1,674회(하루 28회)·≤5봉 48% 는 감수한 대가 |
| 레짐 사이드카 (balgbm) | `data/ensemble/supervised/omega461_balgbm_cut2509_20260909/...regime3_balgbm_cut2509_sidecar.csv` | 2024~2026-08 | 대조 arm | 보류 | balancedish 원본. 강추세 후보의 42.2% 를 chop 으로 오분류(BB 덮어쓰기) |
| 레짐 사이드카 (fwd48 전향) | `data/ensemble/supervised/omega461_fwd48_cut2509_20260909/...regime3_fwd48_cut2509_sidecar.csv` | 2024~2026-08 | 전향 라벨 실험 | **closed-negative** | K1(지연제거) 통과 h=+120봉, **K2 실패** — 방향 격차 CI 6셀 중 1셀만 0 배제, OOS h48 부호 반전 |
