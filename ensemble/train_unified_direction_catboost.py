...
DEFAULT_SAVE = "data/ensemble/supervised/unified_direction_catboost.json"
...
def train(args: argparse.Namespace) -> dict[str, Any]:
    ...
    artifact = {
        ...
        "meta": {
            "algorithm": "unified_direction_catboost",
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Train CatBoost unified direction classifier")
