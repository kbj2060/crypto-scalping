...
const MODEL_INDICATOR_MEANING = {
  ...
  breakout_rev: {
    // 화살표는 **매매 방향**이다(↑ 롱 · ↓ 숏). 발현 방향은 판정과 화살표로 역산된다:
    //   돌파 ↑ = 상승 발현 · 돌파 ↓ = 하락 발현 · 되돌림 ↑ = 하락 발현 · 되돌림 ↓ = 상승 발현.
    "돌파 ↑": "**상승**으로 발현한 뒤 계속 오른다에 걸어 가상 보유 중입니다. 주문은 내지 않습니다.",
    "돌파 ↓": "**하락**으로 발현한 뒤 계속 내린다에 걸어 가상 보유 중입니다. 주문은 내지 않습니다.",
    "되돌림 ↑": "**하락**으로 발현했지만 되돌아온다에 걸어 가상 보유 중입니다. 주문은 내지 않습니다.",
    "되돌림 ↓": "**상승**으로 발현했지만 되돌아온다에 걸어 가상 보유 중입니다. 주문은 내지 않습니다.",
    "혼재 보유": "방향이 반대인 가상 포지션이 동시에 열려 있습니다.",
    "직전 돌파↑": "보유 중이 아니고, 가장 최근 판정이 **상승 발현 → 돌파**였습니다. 배리어가 중앙값 5분에 해소돼 포지션은 짧게만 열립니다.",
    "직전 돌파↓": "보유 중이 아니고, 가장 최근 판정이 **하락 발현 → 돌파**였습니다. 배리어가 중앙값 5분에 해소돼 포지션은 짧게만 열립니다.",
    "직전 되돌림↑": "보유 중이 아니고, 가장 최근 판정이 **하락 발현 → 되돌림**이었습니다. 배리어가 중앙값 5분에 해소돼 포지션은 짧게만 열립니다.",
    "직전 되돌림↓": "보유 중이 아니고, 가장 최근 판정이 **상승 발현 → 되돌림**이었습니다. 배리어가 중앙값 5분에 해소돼 포지션은 짧게만 열립니다.",
