...
PPO_ENTROPY_MIN = 0.005  # 엔트로피 최소값 - 최소 탐험 보장 (0.001 -> 0.005)
PPO_LEARNING_RATE = 0.0002  # 학습률 - 표준 학습률 (2e-4)

# [추가] 고급 PPO 설정 (Value Clip + KL Stop)
...
# 학습 파라미터
TRAIN_ACTION_DIM = 3  # 행동 차원 (0:Neutral, 1:Long, 2:Short) - 3-Action Target Position 구조
TRAIN_BATCH_SIZE = 128  # 배치 크기 (메모리에서 업데이트할 최소 스텝 수)
