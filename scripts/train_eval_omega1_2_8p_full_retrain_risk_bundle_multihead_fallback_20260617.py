...
MODEL_ID = "omega1_2_8p_full_retrain_risk_bundle_multihead_fallback_20260617"
...
def main() -> int:
    ...
    diagnostics: dict[str, Any] = {
        "mode": "full_retrain_parent_numeric_cash_sleeve_with_risk_bundle_multihead_fallback_only",
        ...
        "risk_bundle_semantics": "fallback-only multihead chooses a bundled TP/SL/notional/leverage/max_hold contract; primary parent risk remains unchanged",
