...
MODEL_ID = "omega1_2_8g_full_retrain_numeric_cash_sleeve_tp_extension_guard_20260616"
OUT_DIR = ROOT / "tmp/causal_regen_20260516" / MODEL_ID
RISK = sleeve.FallbackRisk("tp_extension_guard_n081_l2_h192", 0.052, 0.028, 0.81, 2.0, 192)
...
SLTP_BUCKETS = (
    ...
    sleeve.FallbackRisk("extend_tp065_sl028_n081_h192", 0.065, 0.028, 0.81, 2.0, 192),
    sleeve.FallbackRisk("runner_tp078_sl028_n081_h192", 0.078, 0.028, 0.81, 2.0, 192),
)
...
def main() -> int:
    ...
    diagnostics: dict[str, Any] = {
        "mode": "full_retrain_parent_numeric_cash_sleeve_with_tp_extension_guard",
