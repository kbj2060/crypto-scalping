"""zig075, pinned to live's 102-column contract, regime3 = DEFAULT wide24, EVAL_CSV extended to
...
if __name__ == "__main__":
    ...
    if "--out-suffix" not in sys.argv:
        sys.argv += ["--out-suffix", "pinned102_extended_wide24_20260809_zig075"]
    ...
    if "--quality-thresholds" not in sys.argv:
        sys.argv += ["--quality-thresholds", "0.65,0.70,0.75,0.80,0.85"]
