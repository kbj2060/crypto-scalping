...
MODEL_ID = "hf_v13_tree_vs_foundation_summary_full_v40_5_20260512"
...
DEFAULT_OUT_DIR = ROOT / "data/ensemble/supervised/hf_v13_tree_vs_foundation_summary_full_v40_5_20260512"
DEFAULT_REPORT = ROOT / "data/ensemble/reports/hf_v13_tree_vs_foundation_summary_full_v40_5_20260512_summary.json"
DEFAULT_AUDIT = ROOT / "data/ensemble/reports/hf_v13_tree_vs_foundation_summary_full_v40_5_20260512_audit.json"
DEFAULT_GRID = ROOT / "data/ensemble/reports/hf_v13_tree_vs_foundation_summary_full_v40_5_20260512_grid.csv"
...
def main() -> int:
    ...
    print(f"[{MODEL_ID}] preparing summary-factor full-parent tuning set", flush=True)
    ...
    print(f"[{MODEL_ID}] tuning Chronos/Kairos summary-factor full parent on 2025 Q4 validation", flush=True)
    ...
    if best_bundle is None or best_hp is None or best_spec is None or best_val is None:
        raise RuntimeError("summary-factor full-parent tuning produced no valid candidate")
    ...
    with (args.out_dir / "summary_full_bundle.pkl").open("wb") as f:
    ...
    report = {
        "model_id": MODEL_ID,
        "design": "Baseline tree versus summary-factor full parent. Baseline uses the original fixed HGB parent settings. The challenger removes KAN, compresses Chronos-2 and Kairos_23m embeddings into low-dimensional summary factors, appends them to a residual raw feature set, and trains all parent heads on that summary-factor feature space. Summary spec and full-parent HGB hyperparameters are selected on 2025 Q4 validation.",
        ...
        "artifacts": {
            ...
            "summary_full_bundle": str(args.out_dir / "summary_full_bundle.pkl"),
