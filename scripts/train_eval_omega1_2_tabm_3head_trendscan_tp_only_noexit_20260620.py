...
MODEL_ID = "omega1_2_true_3head_tabm_trendscan_tp_only_20260620"
LABEL_DIR = ROOT / "tmp/causal_regen_20260516/trend_scanning_action_labels_exec_confirmed_tp_only_20260620"
OUT_DIR = ROOT / "tmp/causal_regen_20260516" / MODEL_ID


def _add_tp_only_trendscan_labels(year: int) -> pd.DataFrame:
    ...
    if invalid:
        raise RuntimeError(f"{path} invalid TP-only trend-scanning classes: {invalid}")
    return out


def main() -> int:
    direction_base._add_labels = _add_tp_only_trendscan_labels
