...
RUN_DIR="$ROOT/tmp/causal_regen_20260516/ai_patchmix_direction_core_20260530_full"
...
"$PY" "$ROOT/scripts/build_ai_patchmix_direction_core_20260530.py" \
  ...
  --out-csv "$RUN_DIR/fit2024_score2025/ai_patchmix_direction_core_2025.csv" \
  "${COMMON_ARGS[@]}"
...
"$PY" "$ROOT/scripts/build_ai_patchmix_direction_core_20260530.py" \
  ...
  --out-csv "$RUN_DIR/fit2025_score2026/ai_patchmix_direction_core_2026.csv" \
  "${COMMON_ARGS[@]}"
