"""h48qual, pinned to live's 102-column contract, regime3 = JM lambda=4, EVAL_CSV extended to
2026-01-01..06-30 (bypasses the legacy action_score/m7 candidate pipeline entirely -- verified all
102 base_cols exist in raw training_features_2026_rebuilt.csv + a regime3 overlay)."""
...
if __name__ == "__main__":
    ...
    if "--out-suffix" not in sys.argv:
        sys.argv += ["--out-suffix", "pinned102_extended_jmlam4_20260809_h48qual"]
    ...
    if "--quality-thresholds" not in sys.argv:
        sys.argv += ["--quality-thresholds", "0.50,0.60,0.65,0.70,0.75,0.80"]
