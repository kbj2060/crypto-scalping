...
def prepared_frame_timestamps(risk_report: dict[str, Any], parent_report: dict[str, Any]) -> dict[str, pd.Series]:
    import train_eval_omega1_2_tabm_diffusion_risk_sol_20260707 as omega
    import train_eval_omega4_3head_parent72_loose_entry_quality_sol_20260707 as omega4
