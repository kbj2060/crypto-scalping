...
MODEL_ID = "omega1_2_8i_full_retrain_numeric_cash_sleeve_vol_sltp_all_positions_20260616"
OUT_DIR = ROOT / "tmp/causal_regen_20260516" / MODEL_ID
RISK = sleeve.FallbackRisk("vol_normalized_all_positions_n081_l2_h192", 0.052, 0.028, 0.81, 2.0, 192)
...
def main() -> int:
    ...
    diagnostics: dict[str, Any] = {
        "mode": "full_retrain_parent_numeric_cash_sleeve_with_vol_normalized_sltp_all_positions",
        ...
        "vol_normalized_sltp": {
            "vol_source": "past close pct_change rolling std, window=96, min_periods=24; applied to both primary and fallback positions",
    ...
    report = {
        ...
        "method": "Full-retrained 3-head parent artifact is used as parent. Cash sleeve EV lower-bound and numeric utility agreement/veto regressors are newly fit on validation full-retrain features and evaluated on fixed 2026 OOS. Volatility-normalized account-PnL SLTP is applied to both primary and fallback positions during metrics evaluation.",
