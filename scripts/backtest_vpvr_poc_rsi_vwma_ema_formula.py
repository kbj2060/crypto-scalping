...
TUNABLE_FIELDS = [
    ...
    "k_ema", "k_vwma", "k_poc1", "k_poc2", "w_regime_gate",
...
def _sample_params(rng: np.random.Generator) -> dict:
    ...
    return {
        ...
        "rsi_hot": float(rng.uniform(65.0, 85.0)),
        "rsi_cold": float(rng.uniform(15.0, 35.0)),
...
def tune_optuna(
    ...
    def objective(trial: "optuna.Trial") -> float:
        ...
        p = {
            ...
            "theta_exit": theta_exit,
            "theta_full": theta_full,
            "rsi_hot": trial.suggest_float("rsi_hot", 65.0, 85.0),
            "rsi_cold": trial.suggest_float("rsi_cold", 15.0, 35.0),
