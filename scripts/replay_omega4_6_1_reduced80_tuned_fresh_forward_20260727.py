...
CONFIGS = {
    ...
    # 20260727 hyperparameter-sweep result: h48qual's VAL-best config tied with the ORIGINAL
    # hyperparams (epochs 1-4 and weight_decay=0.0015 all converged to an identical early-stopped
    # checkpoint on this 30k-row train set; only dropout=0.20 changed anything, and it was worse),
    # so h48qual reuses the untouched reduced80 bundle+sidecar above unchanged. zig075's VAL-best
    # config was dropout=0.20 (epochs=2 otherwise unchanged) -- retrained bundle + a freshly
    # retrained risk sidecar (same notional-band relaxation deviation as reduced80, documented in
    # NOTIONAL_BAND_DEVIATION; the fixed-leverage-not-dynamic side effect recurred here too:
    # leverage_min==leverage_max==2.0 for this sidecar, same root cause as h48qual's).
    "reduced80_tuned": {
        "h48qual": {
            "bundle": ROOT / "tmp/causal_regen_20260516/omega4_3head_parent72_loose_entry_quality_20260620_reduced80_h48qual_20260724/true_3head_tabm_bundle.pt",
            "pred_dir": ROOT / "tmp/causal_regen_20260516/omega4_3head_parent72_loose_entry_quality_20260620_reduced80_h48qual_20260724",
        ...
        "zig075": {
            "bundle": ROOT / "tmp/causal_regen_20260516/omega4_3head_parent72_loose_entry_quality_20260620_sweep_zig075_c5_e2_drop20_20260727/true_3head_tabm_bundle.pt",
            "pred_dir": ROOT / "tmp/causal_regen_20260516/omega4_3head_parent72_loose_entry_quality_20260620_sweep_zig075_c5_e2_drop20_20260727",
            "sidecar_pkl": ROOT / "tmp/causal_regen_20260516/omega4_2_trade_risk_sidecar_20260622_reduced80_zig075_tuned_drop20_q075_20260727/risk_sidecar.pkl",
            "tag": "q075",
            "direction_label_dir": ROOT / "tmp/causal_regen_20260516/omega_current_only_all_label_candidate_parent_screen_20260629/label_contracts/zigzag_action_labels_20260531",
            "quality_mode": "same_as_direction",
            "quality_label_dir": None,
...
def main() -> int:
    ...
    for model_set in ("baseline102", "reduced80", "reduced80_tuned"):
    ...
    out_path = OUT_DIR / "fresh_forward_comparison_report_tuned_20260727.json"
