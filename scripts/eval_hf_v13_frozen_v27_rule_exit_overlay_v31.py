...
MODEL_ID = "hf_v13_frozen_v27_rule_exit_overlay_v31_20260511"
...
DEFAULT_OUT_DIR = ROOT / "data/ensemble/supervised/hf_v13_frozen_v27_rule_exit_overlay_v31_20260511"
DEFAULT_REPORT = ROOT / "data/ensemble/reports/hf_v13_frozen_v27_rule_exit_overlay_v31_20260511_summary.json"
DEFAULT_AUDIT = ROOT / "data/ensemble/reports/hf_v13_frozen_v27_rule_exit_overlay_v31_20260511_audit.json"
DEFAULT_GRID = ROOT / "data/ensemble/reports/hf_v13_frozen_v27_rule_exit_overlay_v31_20260511_grid.csv"
SEQ_LEN = 72
        ...
        if pos != 0:
            ...
            if owner == "deep_alpha":
                ...
                if cfg.sl_vol_mult > 0.0:
                    ...
                    effective_sl = vol_sl
                if mfe > 0.0 and mfe >= float(getattr(cfg, "trail_activation", 0.009)) and cfg.trail_gap_mult > 0.0:
