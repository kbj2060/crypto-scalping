#!/usr/bin/env python3
"""BTC Phase 3 + 3b -- is the S24_K3 candidate label learnable, and does it make a better gate once
...
BTC LINEAGE
  ...
  Phase 2 (research_btc_regime_label_conditional_lift_20260902.py): S24_K3 selected. Among
...
def main() -> None:
    ...
    print(f"TRAIN {int(tr.sum()):,} / OOS {int(oos.sum()):,} bars | S24_K3 T1={t1:.6f} T2={t2:.6f}")
