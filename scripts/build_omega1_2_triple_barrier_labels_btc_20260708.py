#!/usr/bin/env python3
"""BTC copy of build_omega1_2_triple_barrier_labels_20260619.py.

Only TRAIN_CSV/EVAL_CSV/OUT_DIR/MODEL_ID are repointed at BTC data; the barrier
...
MODEL_ID = "btc_omega1_2_triple_barrier_labels_20260708"
