...
import train_eval_omega4_3head_parent72_loose_entry_quality_btc_swingtransition_zigzag_20260806 as omega4  # noqa: E402
...
def main() -> int:
    ...
    ap.add_argument("--baseline-bundle", type=Path, default=ROOT / "tmp/causal_regen_20260516/btc_omega4_3head_parent72_loose_entry_quality_swingtransition_zigzag_20260806_h48qual_20260806_swingtransition_zigzag/true_3head_tabm_bundle.pt")
    ap.add_argument("--sidecar-pkl", type=Path, default=ROOT / "tmp/causal_regen_20260516/btc_omega4_2_trade_risk_sidecar_20260708_h48qual_q055_20260806_swingtransition_zigzag/risk_sidecar.pkl")
    ap.add_argument("--precomputed-prediction-dir", type=Path, default=ROOT / "tmp/causal_regen_20260516/btc_omega4_3head_parent72_loose_entry_quality_swingtransition_zigzag_20260806_h48qual_freshforward_ext_20260806")
    ...
    ap.add_argument("--out-dir", type=Path, default=ROOT / "tmp/causal_regen_20260516/btc_final_scale_map_swingtransition_zigzag_freshforward_ext_20260806")
