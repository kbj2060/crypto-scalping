...
MODEL_ID = "omega1_2_8h_full_retrain_numeric_cash_sleeve_vol_normalized_sltp_20260616"
...
def _vol_score(frame: pd.DataFrame) -> np.ndarray:
    ...
    return ret.rolling(96, min_periods=24).std().fillna(method="bfill").fillna(0.0).to_numpy(dtype=np.float64)
...
def main() -> int:
    ...
    diagnostics: dict[str, Any] = {
        "mode": "full_retrain_parent_numeric_cash_sleeve_with_vol_normalized_sltp",
