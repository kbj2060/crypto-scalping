...
MODEL_ID = "hf_v13_tree_vs_foundation_target_aware_lgbm_v40_7_20260512"
...
DEFAULT_OUT_DIR = ROOT / "data/ensemble/supervised/hf_v13_tree_vs_foundation_target_aware_lgbm_v40_7_20260512"
DEFAULT_REPORT = ROOT / "data/ensemble/reports/hf_v13_tree_vs_foundation_target_aware_lgbm_v40_7_20260512_summary.json"
DEFAULT_AUDIT = ROOT / "data/ensemble/reports/hf_v13_tree_vs_foundation_target_aware_lgbm_v40_7_20260512_audit.json"
DEFAULT_GRID = ROOT / "data/ensemble/reports/hf_v13_tree_vs_foundation_target_aware_lgbm_v40_7_20260512_grid.csv"
...
class TreeHParams:
    ...
    def name(self) -> str:
        ...
        return f"lgbm_ne{self.max_iter}_lr{lr}_leaves{self.max_leaf_nodes}_l2{l2}_cw{str(self.cash_weight).replace('.', 'p')}"
...
def _classifier_hp(seed: int, hp: TreeHParams) -> Any:
    return make_pipeline(
        ...
        LGBMClassifier(
            n_estimators=int(hp.max_iter),
            learning_rate=float(hp.learning_rate),
            num_leaves=int(hp.max_leaf_nodes),
            reg_lambda=float(hp.l2_regularization),
...
def _projection_grid() -> list[ProjectionSpec]:
    return [
        ...
        ProjectionSpec(2, 1, True),
        ProjectionSpec(2, 2, True),
        ProjectionSpec(3, 2, True),
        ProjectionSpec(3, 3, True),
        ProjectionSpec(2, 1, False),
        ProjectionSpec(2, 2, False),
        ProjectionSpec(3, 2, False),
    ]
