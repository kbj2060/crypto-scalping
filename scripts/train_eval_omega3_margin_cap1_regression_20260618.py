...
MODEL_ID = "omega3_margin_cap1_regression_fixedlev2_20260618"
...
def main() -> int:
    ...
    diagnostics: dict[str, Any] = {
        ...
        "parent_risk_source": {
            ...
            "head_contract": "tp_price_move/sl_price_move/margin_fraction; leverage fixed at 2; notional and account TP/SL are derived",
        },
        "risk": {**asdict(RISK), "fixed_leverage": float(FIXED_LEVERAGE), "margin_fraction_max": float(PARENT_RISK_MARGIN_FRACTION_MAX), "effective_notional_max": float(PARENT_RISK_NOTIONAL_EFFECTIVE_MAX)},
