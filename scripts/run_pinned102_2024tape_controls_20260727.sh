#!/usr/bin/env bash
# RESEARCH ONLY -- launches the two live-equivalent controls (h48qual, zig075) on the recovered
# 2024+2025 training tape, in parallel. Kept as a file for reliable variable expansion through
# the wsl/PowerShell quoting layers (learned the hard way earlier this session).
set -u

cd /home/llewyn/crypto-scalping

S=scripts/train_eval_omega4_3head_parent72_pinned102_2024tape_20260727.py
L=tmp/research_20260727/pinned102_2024tape
...
python "$S" --pin-component h48qual --out-suffix pinned102_2024tape_20260727_h48qual_control \
  ...
  > "$L/h48qual_control.log" 2>&1 &

python "$S" --pin-component zig075 --out-suffix pinned102_2024tape_20260727_zig075_control \
