#!/usr/bin/env python3
"""Red-team audit for the Omega 4.6.2 roll24 daytrade overlay."""
...
EVAL_SCRIPT = ROOT / "scripts/eval_omega4_6_2_roll24_daytrade_overlay_20260701.py"
PRIOR_RUNTIME_AUDIT = (
...
AUDIT_MD = ROOT / "docs/audits/omega4_6_2_roll24_daytrade_redteam_20260701.md"
TOL = 1.0e-8


def load_audit_v1() -> Any:
    spec = importlib.util.spec_from_file_location("omega462_loss_cluster_audit_v1_for_roll24", AUDIT_V1_PATH)
...
def main() -> None:
    ...
    payload = {
        "audit_id": "omega4_6_2_roll24_daytrade_redteam_20260701",
