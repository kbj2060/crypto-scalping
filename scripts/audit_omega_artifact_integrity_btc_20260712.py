#!/usr/bin/env python3
"""Fail-fast artifact integrity audit for Omega promotion candidates (BTC).
...
BTC analogue of audit_omega_artifact_integrity_sol_20260707.py (itself the SOL
analogue of audit_omega_artifact_integrity_20260630.py). Unlike the SOL copy,
audit_id and output filenames are asset-specific here to avoid collisions if
ETH/SOL/BTC audits ever write into the same out_dir.
"""
...
AUDIT_ID = "omega_artifact_integrity_audit_btc_20260712"
...
def prepared_frame_timestamps(risk_report: dict[str, Any], parent_report: dict[str, Any]) -> dict[str, pd.Series]:
    import train_eval_omega1_2_tabm_diffusion_risk_btc_20260708 as omega
    import train_eval_omega4_3head_parent72_loose_entry_quality_btc_20260708 as omega4
...
def write_markdown(path: Path, audit: dict[str, Any]) -> None:
    lines = [
        f"# Omega Artifact Integrity Audit (BTC) - {audit['created_at']}",
        "",
