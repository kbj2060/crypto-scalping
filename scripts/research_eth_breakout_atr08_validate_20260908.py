#!/usr/bin/env python3
"""ATR상대 배리어 0.8× 단독 검정 -- 셔플 귀무(B=32) + 무작위 시드 20개 (2026-09-08).

격자 5칸에서 고른 구성이므로 승격 전에 단독 검정을 받는다. 현행(절대 0.25%)과 같은 절차·
같은 시드 리스트를 써서 **직접 비교**한다.
