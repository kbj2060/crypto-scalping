...
MODEL_ID = "alpha3_dsac_exit_owner_v5_20260515"
OUT_DIR = ROOT / "data/ensemble/supervised/alpha3_dsac_exit_owner_v5_20260515"
MODEL_OUT = OUT_DIR / "dsac_exit_owner_v5.pt"
REPORT_OUT = ROOT / "data/ensemble/reports/alpha3_dsac_exit_owner_v5_20260515_summary.json"
AUDIT_OUT = ROOT / "data/ensemble/reports/alpha3_dsac_exit_owner_v5_20260515_audit.json"
GRID_OUT = ROOT / "data/ensemble/reports/alpha3_dsac_exit_owner_v5_20260515_grid.csv"
DATASET_OUT = ROOT / "data/ensemble/reports/alpha3_dsac_exit_owner_v5_20260515_dataset.json"
    ...
    *,
    ...
    if force_exit:
        if effective_sl > 0.0 and unreal <= -abs(effective_sl):
            return "close_100"
        return action_name if action_name != "hold" else "close_100"
...
def main() -> int:
    ...
    for mode_i, mode in enumerate(FEATURE_MODES):
        ...
        model_out = OUT_DIR / f"dsac_exit_owner_v5_{mode}.pt"
    ...
    experiments = [
        ...
        {
            "name": f"alpha3_dsac_exit_owner_v5::{selected_mode}::{selected_policy.name}",
