#!/usr/bin/env python3
"""Two-component greedy router replay for SOL/BTC Omega4.6.1 replicas.

This tests the ETH-style h48qual > zig075 single-account router on asset
replicas. Each component keeps its own parent bundle, prediction tag, risk
sidecar, ATR TP/SL, learned exit-head, and final side scale. A shared position
slot means zig075 signals are ignored while an h48qual/zig075 position is open.
"""
...
CONFIGS = {
    "sol": {
        "h48qual": {
            "parent_dir": "tmp/causal_regen_20260516/sol_omega4_3head_parent72_loose_entry_quality_20260707_h48qual_20260707",
            "risk_dir": "tmp/causal_regen_20260516/sol_omega4_2_trade_risk_sidecar_20260707_h48qual_q045_20260708",
            "tag": "q045",
            "long_scale": 1.0,
            "short_scale": 1.0,
        },
    ...
    "btc": {
        ...
        "zig075": {
            "parent_dir": "tmp/causal_regen_20260516/btc_omega4_3head_parent72_loose_entry_quality_20260708_zig075_20260708",
            "risk_dir": "tmp/causal_regen_20260516/btc_omega4_2_trade_risk_sidecar_20260708_zig075_q065_20260708",
            "tag": "q065",
            "long_scale": 2.5,
            "short_scale": 2.75,
        },
...
def main() -> int:
    ...
    asset = args.asset
    date = ASSET_DATES[asset]
    out_dir = args.out_dir or ROOT / "tmp/causal_regen_20260516" / f"{asset}_omega4_6_1_two_component_router_20260708"
    ...
    report = {
        "method": "asset_two_component_greedy_router_exact_replay",
        "asset": asset,
