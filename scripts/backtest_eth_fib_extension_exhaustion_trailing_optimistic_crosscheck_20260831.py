...
(backtest_eth_fib_extension_exhaustion_trailing_gridsearch_20260831.py: 9/96 combos passed
VAL+OOS, top 4 all share ARM=0.5 and Trail<=0.2 -- exactly the case
...
CANDIDATES = [
    ...
    {"sl": 3.5, "arm": 0.5, "trail": 0.2},
]


def log(msg: str) -> None:
    print(f"[fib_ext_optimistic_crosscheck] {msg}", flush=True)
