...
def main() -> int:
    ...
    ap.add_argument("--baseline-bundle", type=Path, default=ROOT / "tmp/causal_regen_20260516/btc_omega4_3head_parent72_loose_entry_quality_20260708_h48qual_20260708/true_3head_tabm_bundle.pt")
    ...
    ap.add_argument("--precomputed-prediction-dir", type=Path, default=ROOT / "tmp/causal_regen_20260516/btc_omega4_3head_parent72_loose_entry_quality_20260708_h48qual_freshforward_ext_20260801")
    ...
    ap.add_argument("--out-dir", type=Path, default=ROOT / "tmp/causal_regen_20260516/btc_final_scale_map_20260708_freshforward_ext")
    ...
    frames = omega4._prepare_frames(
        disable_tp_sl=False,
        direction_label_dir=ROOT / "tmp/causal_regen_20260516/btc_zigzag_action_labels_freshforward_ext_20260801",
        quality_mode="quality_label_action",
        quality_label_dir=ROOT / "tmp/causal_regen_20260516/btc_h48_conservative_padded_freshforward_ext_20260801",
