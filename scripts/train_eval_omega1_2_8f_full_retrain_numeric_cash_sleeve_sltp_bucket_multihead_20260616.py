...
MODEL_ID = "omega1_2_8f_full_retrain_numeric_cash_sleeve_sltp_bucket_multihead_20260616"
OUT_DIR = ROOT / "tmp/causal_regen_20260516" / MODEL_ID
RISK = sleeve.FallbackRisk("sltp_bucket_multihead_n081_l2_h192", 0.052, 0.028, 0.81, 2.0, 192)
BASELINE_ID = "omega1_2_true_3head_tabm_20260603_full_retrain_cash_alpha43_20260608"
SLTP_BUCKETS = (
    sleeve.FallbackRisk("tight_safe_tp040_sl020_n081_h192", 0.040, 0.020, 0.81, 2.0, 192),
    sleeve.FallbackRisk("base_tp052_sl028_n081_h192", 0.052, 0.028, 0.81, 2.0, 192),
    sleeve.FallbackRisk("wide_tp065_sl034_n081_h192", 0.065, 0.034, 0.81, 2.0, 192),
    sleeve.FallbackRisk("runner_tp078_sl042_n081_h192", 0.078, 0.042, 0.81, 2.0, 192),
)
...
def main() -> int:
    ...
    diagnostics: dict[str, Any] = {
        "mode": "full_retrain_parent_numeric_cash_sleeve_with_sltp_bucket_multihead",
        ...
        "sltp_buckets": [asdict(r) for r in SLTP_BUCKETS],
