...
QUALITY_PATH = ROOT / "data/splits/year_oos/btc_1h_zigzag_quality_meta_labels_20260806.parquet"
...
def main() -> int:
    ...
    df.to_parquet(ROOT / "tmp/btc_1h_volregime_20260805/zigzag_quality_pred_full.parquet", index=False)
    return 0
