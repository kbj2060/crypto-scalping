...
MODEL_ID = "alpha7_regime3_current_moe_active_mix_expert_scale_20260601"
OUT_DIR = ROOT / "tmp/causal_regen_20260516/alpha7_regime3_current_moe_active_mix_expert_scale_20260601"
...
def main() -> int:
    ...
    for bull, bear, chop in itertools.product([0.85, 1.0, 1.10], [0.85, 1.0, 1.15, 1.30], [0.80, 1.0, 1.10]):
    ...
    report = {
        "model_id": MODEL_ID,
        "design": "Per-expert notional/position scaling on top of the active current-Regime3 MoE expert-source mix. Routing and expert models are unchanged.",
        "overlay": overlay,
        "selected": {
