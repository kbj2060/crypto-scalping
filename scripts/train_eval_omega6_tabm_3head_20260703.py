#!/usr/bin/env python3
# Forked from train_eval_omega1_2_tabm_3head_20260603.py: identical architecture/bundle
# contract, only MODEL_ID/OUT_DIR changed for Omega6 artifact provenance.
...
MODEL_ID = "omega6_true_3head_tabm_20260703"
