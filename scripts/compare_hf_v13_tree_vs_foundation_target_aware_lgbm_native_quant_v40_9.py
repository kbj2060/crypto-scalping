...
MODEL_ID = "hf_v13_tree_vs_foundation_target_aware_lgbm_native_quant_v40_9_20260512"
...
DEFAULT_OUT_DIR = ROOT / "data/ensemble/supervised/hf_v13_tree_vs_foundation_target_aware_lgbm_native_quant_v40_9_20260512"
DEFAULT_REPORT = ROOT / "data/ensemble/reports/hf_v13_tree_vs_foundation_target_aware_lgbm_native_quant_v40_9_20260512_summary.json"
DEFAULT_AUDIT = ROOT / "data/ensemble/reports/hf_v13_tree_vs_foundation_target_aware_lgbm_native_quant_v40_9_20260512_audit.json"
DEFAULT_GRID = ROOT / "data/ensemble/reports/hf_v13_tree_vs_foundation_target_aware_lgbm_native_quant_v40_9_20260512_grid.csv"
...
def main() -> int:
    ...
    train_macro = _extract_macro_embeddings(
        ...
        cache_path=_embedding_cache_path(
            ...
            extra_tag=f"csv={args.train_csv.name}|stride={args.train_stride}|split=train|consumer={MODEL_ID}",
        ),
    ...
    val_macro = _extract_macro_embeddings(
        ...
        cache_path=_embedding_cache_path(
            ...
            window_len=MACRO_LEN,
            extra_tag=f"csv={args.train_csv.name}|split=val|consumer={MODEL_ID}",
        ),
        batch_size=args.embed_batch,
    )
    eval_macro = _extract_macro_embeddings(
        ...
        cache_path=_embedding_cache_path(
            ...
            window_len=MACRO_LEN,
            extra_tag=f"csv={args.eval_csv.name}|split=eval|consumer={MODEL_ID}",
        ),
        batch_size=args.embed_batch,
    )
