"""FULL 6-MONTH corrected router comparison: both components pinned to live's 102-column contract,
regime3->JM lambda=4, thresholds activation-matched (h48qual q070, zig075 q080), full data-gap fixes
applied (regenerated direction labels, quality labels, JM regime3, regime3_risk -- all now cover
2026-01-01..06-29 with zero internal gaps). Baseline uses wide24 at each component's live q_tag
(h48qual q050, zig075 q075), also retrained on the same extended pipeline for a fair comparison.
Supersedes the Jan-Feb-only run (rerun_eth_greedy_router_regime_jmlam4_pinned102_matched_20260809.py).
"""
...
OUT_DIR = ROOT / "tmp/eth_greedy_router_regime_jmlam4_pinned102_extended_20260809"
START, END = "2026-01-01", "2026-06-29"

JM_H48QUAL_DIR = ROOT / "tmp/causal_regen_20260516/omega4_3head_parent72_loose_entry_quality_20260620_pinned102_extended_jmlam4_20260809_h48qual"
JM_H48QUAL_SIDECAR = ROOT / "tmp/causal_regen_20260516/omega4_2_trade_risk_sidecar_20260622_pinned102_extended_jmlam4_q070_20260809/risk_sidecar.pkl"
JM_ZIG075_DIR = ROOT / "tmp/causal_regen_20260516/omega4_3head_parent72_loose_entry_quality_20260620_pinned102_extended_jmlam4_20260809_zig075"
JM_ZIG075_SIDECAR = ROOT / "tmp/causal_regen_20260516/omega4_2_trade_risk_sidecar_20260622_pinned102_extended_jmlam4_q080_20260809/risk_sidecar.pkl"
JM_REGIME3_2026 = ROOT / "data/ensemble/supervised/eth_regime3_current_hmm_jmlam4_20260809_2026_cleansource_maskedname.csv"

BASELINE_H48QUAL_DIR = ROOT / "tmp/causal_regen_20260516/omega4_3head_parent72_loose_entry_quality_20260620_pinned102_extended_wide24_20260809_h48qual"
BASELINE_ZIG075_DIR = ROOT / "tmp/causal_regen_20260516/omega4_3head_parent72_loose_entry_quality_20260620_pinned102_extended_wide24_20260809_zig075"
BASELINE_H48QUAL_PRED = BASELINE_H48QUAL_DIR / "oos_predictions_q050.csv"
BASELINE_ZIG075_PRED = BASELINE_ZIG075_DIR / "oos_predictions_q075.csv"
...
def main() -> int:
    ...
    result_baseline = run_router("baseline_wide24_extended", use_jm=False, common_ts=common_ts_series)
    result_jm = run_router("jmlam4_pinned102_extended", use_jm=True, common_ts=common_ts_series)
    out = {
        "window": [START, END],
        "common_bars": len(common_ts),
        "note": "FULL 6-month corrected comparison: both components 102-feature-pinned, regime3->JM (h48qual q070, zig075 q080), all data gaps fixed.",
        "baseline_wide24_extended_full_router": result_baseline,
        "jmlam4_pinned102_extended_full_router": result_jm,
    }
