...
기본 아티팩트 = **`1d × 예측 E|r| 상위10% × 20자산`**.
⛔**2026-09-16: 「1순위 후보」에서 「관측 수집」으로 낮췄다**(status=OBSERVATION_ONLY_FRAGILE_TO_WARMUP).
09-15 에 이 칸을 1순위로 고른 근거 셋(감쇠 없음 +17.9/+18.9/+29.1 · 모델−롱 +21.72 · 14/20 자산)이
**웜업 섭동에서 전부 뒤집혔다**: 같은 셀·같은 시험창(2024-01~2026-08)·같은 코드인데 인과 확장창의
**웜업 시작일만** 2024-01 → 2022-07 로 바꾸면 사건 집합이 9% 달라지고(2,214→2,017)
건당 **+20.48 → +4.80** · 연도 **+1.3/−4.6/+35.2** · **모델−롱 −11.19(부호 반전)** · 11/20 p0.412 다.
2022~23 까지 붙이면 합산 t **+0.10** · 건당 −3.99 · 모델−롱 −20.37.
재현: `research_direction_event_expansion_20260915.py --stage confirm --hz 1d --gateq 0.90`.

🔴그래도 계속 돌리는 이유(사용자 결정 2026-09-16): **주문을 안 내니 비용이 0이고**, 과거를 더
붙이는 길은 09-15 15:22 에 닫혔으므로(독립일 +48% 인데 t 2.58→1.71) **앞으로 쌓이는 관측**이
남은 유일한 경로다. 다만 이건 **후보의 성과 측정이 아니라 관측 수집**이다 — 이 원장의 숫자를
「검증된 엣지」로 인용하지 말 것.
