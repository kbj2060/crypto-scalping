...
MODEL_ID = "hf_v13_tree_vs_foundation_target_aware_lgbm_native_v40_8_20260512"
...
DEFAULT_OUT_DIR = ROOT / "data/ensemble/supervised/hf_v13_tree_vs_foundation_target_aware_lgbm_native_v40_8_20260512"
DEFAULT_REPORT = ROOT / "data/ensemble/reports/hf_v13_tree_vs_foundation_target_aware_lgbm_native_v40_8_20260512_summary.json"
DEFAULT_AUDIT = ROOT / "data/ensemble/reports/hf_v13_tree_vs_foundation_target_aware_lgbm_native_v40_8_20260512_audit.json"
DEFAULT_GRID = ROOT / "data/ensemble/reports/hf_v13_tree_vs_foundation_target_aware_lgbm_native_v40_8_20260512_grid.csv"
...
def _encoded_hparam_grid() -> list[TreeHParams]:
    return [
        TreeHParams(180, 0.030, 15, 4, 80, 0.02, 0.30, 1.50, 0.80, 0.80, 0.45),
        TreeHParams(220, 0.025, 15, 4, 120, 0.05, 0.50, 2.00, 0.75, 0.75, 0.50),
        TreeHParams(260, 0.020, 23, 5, 120, 0.03, 0.30, 1.50, 0.80, 0.85, 0.45),
        TreeHParams(320, 0.015, 31, 5, 160, 0.05, 0.80, 2.50, 0.70, 0.75, 0.55),
        TreeHParams(240, 0.020, 15, 4, 180, 0.08, 1.00, 3.00, 0.70, 0.70, 0.60),
        TreeHParams(200, 0.035, 7, 3, 100, 0.05, 0.50, 2.50, 0.85, 0.75, 0.50),
    ]
...
def main() -> int:
    ...
    residual_keep_cols = list(x_train_base.columns)
