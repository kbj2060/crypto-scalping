...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--data-path", default="data/splits/year_oos/training_features_2025.csv")
    parser.add_argument("--rl-path", default="data/splits/year_oos/rl_base_2025.csv")
