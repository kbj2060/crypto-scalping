...
MODEL_ID = "omega1_2_8l_full_retrain_numeric_cash_sleeve_half_price_width_vol_sltp_20260617"
OUT_DIR = ROOT / "tmp/causal_regen_20260516" / MODEL_ID
RISK = sleeve.FallbackRisk("half_width_vol_normalized_sltp_n081_l2_h192", 0.026, 0.014, 0.81, 2.0, 192)
BASELINE_ID = "omega1_2_true_3head_tabm_20260603_full_retrain_cash_alpha43_20260608"
VOL_RISKS = (
    sleeve.FallbackRisk("half_width_vol_base_tp026_sl014_n081_h192", 0.026, 0.014, 0.81, 2.0, 192),
    sleeve.FallbackRisk("half_width_vol_wide_tp0325_sl017_n081_h192", 0.0325, 0.017, 0.81, 2.0, 192),
    sleeve.FallbackRisk("half_width_vol_runner_tp039_sl021_n081_h192", 0.039, 0.021, 0.81, 2.0, 192),
)
UTILITY_CFGS = (
...
def main() -> int:
    ...
    diagnostics: dict[str, Any] = {
        "mode": "full_retrain_parent_numeric_cash_sleeve_with_half_price_width_vol_normalized_sltp",
        ...
        "vol_normalized_sltp": {
            ...
            "application": "fallback positions only; account-PnL TP/SL thresholds are half of omega1_2_8h, so price distance is also half at the same notional_exposure=0.81",
