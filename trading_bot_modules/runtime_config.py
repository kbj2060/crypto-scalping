...
FINAL_GOVERNOR_REGIME4_PRED_ENABLE = _env_flag("FINAL_GOVERNOR_REGIME4_PRED_ENABLE", True)
FINAL_GOVERNOR_REGIME4_PRED_CLEAN_MODEL_PATH = os.getenv(
    "FINAL_GOVERNOR_REGIME4_PRED_CLEAN_MODEL_PATH",
    "data/ensemble/supervised/clean_regime4_raw_state12_v1_20260517/clean_regime4_raw_state12_v1_2024.joblib",
)
FINAL_GOVERNOR_REGIME4_PRED_MODEL_PATH = os.getenv(
    "FINAL_GOVERNOR_REGIME4_PRED_MODEL_PATH",
    "data/ensemble/supervised/regime4_pred_tft_h12_nomdjd_all74_20260517/regime4_pred_tft_vsn_selected_2024.pt",
)
FINAL_GOVERNOR_REGIME4_PRED_HORIZON_BARS = int(float(os.getenv("FINAL_GOVERNOR_REGIME4_PRED_HORIZON_BARS", "12")))
FINAL_GOVERNOR_REGIME4_PRED_SEQ_LEN = int(float(os.getenv("FINAL_GOVERNOR_REGIME4_PRED_SEQ_LEN", "72")))
FINAL_GOVERNOR_REGIME4_PRED_BATCH_SIZE = int(float(os.getenv("FINAL_GOVERNOR_REGIME4_PRED_BATCH_SIZE", "1536")))
FINAL_GOVERNOR_REGIME4_PRED_D_MODEL = int(float(os.getenv("FINAL_GOVERNOR_REGIME4_PRED_D_MODEL", "64")))
FINAL_GOVERNOR_REGIME4_PRED_HEADS = int(float(os.getenv("FINAL_GOVERNOR_REGIME4_PRED_HEADS", "4")))
FINAL_GOVERNOR_REGIME4_PRED_LAYERS = int(float(os.getenv("FINAL_GOVERNOR_REGIME4_PRED_LAYERS", "2")))
FINAL_GOVERNOR_REGIME4_PRED_DROPOUT = float(os.getenv("FINAL_GOVERNOR_REGIME4_PRED_DROPOUT", "0.12"))
